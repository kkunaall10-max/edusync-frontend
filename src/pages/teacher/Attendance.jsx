            ...
            <main style={styles.mainContent}>
                ...
                <div style={styles.headerGlass}>
                  <div style={{display:'flex', alignItems:'center', gap:15}}>
                    ...
                    <h1 style={{ color: 'white', fontSize: 20, fontWeight: 700, margin: 0 }}>Roll Book: {teacherProfile?.class_assigned}-{teacherProfile?.section_assigned}</h1>
                  </div>
                ...
                <div style={styles.glassCard}>
                    ...
                    <button onClick={submitAttendance} style={{ width:'100%', padding:'16px', background:'#2563EB', color:'white', border:'none', borderRadius:'16px', fontWeight:'800', marginTop:'24px', cursor:'pointer' }}>Save Attendance Records</button>
                </div>
            </main>
        </div>
    );
